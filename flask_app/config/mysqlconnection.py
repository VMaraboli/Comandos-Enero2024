'''
    ...
    result = connectToMySQL('crud_modularizado'.query_db(query))#recibo una lista de diccionarios

    diccionario = {
        "nombre" = "Elena",
        "apellido" = "De Troya",
        "email" = "elena@codingdojo.cl"
    }

    query = "INSERT INTO usuarios (nombre, apellido, email) VALUES (%(nombre)s, %(apellido)s, %(email)s) #interpolación %(email)s
